...
--
-- Host: localhost    Database: new_hr_qa3
-- ------------------------------------------------------
...
CREATE TABLE `rv_monthly_report` (
  ...
  `total` int(5) NOT NULL DEFAULT '100' COMMENT '總分 - 應該是不需要，因爲是計算出來的',
...
-- Dump completed on 2017-04-24 15:05:09
