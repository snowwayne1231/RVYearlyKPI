...
INSERT INTO `rv_email_template` VALUES ('23', 'yearly_assessment_launch', '【年度考評通知】 {year} 年　年度績效考核作業', '<h3>您好：</h3><p>本年度「績效考核作業」已開始進行，敬請同仁儘速完成自評作業；</p><p>各部門考核作業請於{year2}年{month}月{day}日前完成，謝謝！</p><p>【人事考評系統】</p>\r\n<p>入口網址：<a href=\"http://{URL}\">{URL}</a></p><p>帳 號：員編</p><p>密 碼：身分證字號（預設）</p><br><br><p>人力資源處</p>', '0', '2017-12-29 15:01:30');
...
INSERT INTO `rv_email_template` VALUES ('25', 'yearly_assessment_all_report_done', '【年度考評通知】 {year} 年　年度績效考核作業 - 部門單位評核', '<h3>您好：</h3><p>本年度「績效考核作業」個人考核表已全數完成。\r\n開始進行部門級別單位之分數調整階段，請儘速完成各部門考核作業，謝謝！</p><p>【人事考評系統】</p><p> 入口網址: <a target=\"_blank\" href=\"http://{URL}\">{URL}</a> </p> <p> 帳     號：員編 </p> <p>密     碼：身分證字號（預設） </p> <br><br> <p>人力資源處</p>', '0', '2017-12-05 17:39:53');
INSERT INTO `rv_email_template` VALUES ('26', 'yearly_division_done', '【年度考評 - 批准通知】{year} 年　年度績效考核作業核定完成', '<h3>您好：</h3><p>本年度「績效考核作業」已核定完成，同仁請自行登入系統查看個人考核結果，謝謝！</p><p>【人事考評系統】</p><p> 入口網址: <a target=\"_blank\" href=\"http://{URL}\">{URL}</a> </p> <p> 帳     號：員編 </p> <p>密     碼：身分證字號（預設） </p> <br><br> <p>人力資源處</p>', '0', '2018-01-02 16:06:19');
