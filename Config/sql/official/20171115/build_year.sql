...
CREATE TABLE `rv_year_performance_config_cyclical` (
  ...
  `feedback_status` int(2) NOT NULL DEFAULT '0' COMMENT '問卷回饋提交狀態',
  `feedback_addition_day` int(6) DEFAULT '7' COMMENT '問卷回饋提交天數',
  `feedback_date_start` date DEFAULT '0000-00-00' COMMENT '問卷回饋起始時間',
  `feedback_date_end` date DEFAULT '0000-00-00' COMMENT '問卷回饋結束時間',
  `feedback_choice_ids` varchar(127) NOT NULL DEFAULT '[]' COMMENT '年度問卷回饋選擇題id',
  `feedback_question_ids` varchar(63) NOT NULL DEFAULT '[]' COMMENT '年度問卷回饋問答題id',
...
INSERT INTO `rv_year_performance_feedback_questions` VALUES ('5', 'others', '建議', '除了您的受評主管之外，對於其它單位主管，是否有任何是您想提出嘉許或建議的？', '4', '1');
